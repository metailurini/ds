...
Current status: `v0.9.0` implementation and tests are complete for the scoped user-defined functions pass; `v0.10.0` implementation is complete without tests for the scoped arrays, maps, and array-loop pass. Tests have not been added yet.
