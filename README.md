...
Current status: `v0.5.0` implementation and tests are complete for the scoped first-class CLI argument pass. Existing `v0.1.0` through `v0.5.0` regression suites continue to pass.
