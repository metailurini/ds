...
| List/map literal representation | AST collection literals lowered to HIR array/map expressions; see `docs/maintenance/m3-6-mutable-collections.md` | Parser for literal syntax shape; lowerer for key/value/element portability and duplicate/empty-key policy | VM runtime containers; Bash arrays/associative arrays plus value-type metadata | `docs/maintenance/m3-6-mutable-collections.md`, language docs, runtime docs | VM/Bash parity tests; duplicate/invalid key and nonportable element diagnostics | **Watch** |
