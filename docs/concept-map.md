...
| Index assignment | Explicitly deferred until explicit HIR assignment-target/mutation semantics exist; see `docs/maintenance/m3-6-mutable-collections.md` | Parser may reject malformed assignment shape today; lowerer must reject if/when parseable as a collection assignment target | None until supported | `docs/maintenance/m3-6-mutable-collections.md`, language docs and roadmap/milestones | Diagnostic tests now; future VM/Bash parity tests before acceptance | **Clear while rejected** |
| Nested collection mutation | Explicitly deferred until nested value/reference semantics and Bash encoding are specified; see `docs/maintenance/m3-6-mutable-collections.md` | Lowerer should reject parseable nested mutation forms | None until supported | `docs/maintenance/m3-6-mutable-collections.md`, language/runtime docs | Diagnostic tests now; future VM/Bash parity tests before acceptance | **Clear while rejected** |
