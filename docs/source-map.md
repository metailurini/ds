...
| Mutable collections | accepted literals/indexing/push/array loops are HIR-backed; Bash push updates array element-type sidecars; unsupported assignment syntax is parser-rejected | do not add mutation AST/HIR without a parity contract |
