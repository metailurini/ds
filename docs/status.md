...
`v0.22.2` signal syntax/diagnostic surface pass, the `v0.22.3` deterministic signal-harness pass, the `v0.22.4` foreground direct-command signal-runtime pass, and the `v0.22.5` foreground pipeline signal-runtime pass. It is not a replacement for the roadmap or
...
through the `v0.22.5` foreground pipeline signal-runtime pass:
