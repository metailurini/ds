...
const char *ds_bash_function_value_helpers_source(void) {
    return
        ...
        "  case \"$__ds_return_type\" in string|int|bool|null) ;; *) rm -rf \"$__ds_cv_tmpdir\"; __ds_error \"invalid internal function return type '$__ds_return_type'\" ;; esac\n"
        ...
        "  printf -v \"$1\" '%s' \"$__ds_return_value\"\n"
        "}\n"
        "__ds_call_value() {\n"
