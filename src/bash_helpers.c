...
const char *ds_bash_function_value_helpers_source(void) {
    return
        ...
        "  __ds_return_type=\n"
        "  __ds_return_value=\n"
        "  unset -v __ds_return_array __ds_return_elem_type __ds_return_map __ds_return_value_type __ds_return_stdout __ds_return_stderr __ds_return_code __ds_return_ok __ds_return_failed 2>/dev/null || true\n"
        ...
        "  if [[ \"$__ds_return_type\" == array ]]; then declare -p __ds_return_array >/dev/null 2>&1 || { rm -rf \"$__ds_cv_tmpdir\"; __ds_error 'invalid internal array function return payload'; }; declare -p __ds_return_elem_type >/dev/null 2>&1 || declare -ga __ds_return_elem_type=(); fi\n"
        "  if [[ \"$__ds_return_type\" == map ]]; then declare -p __ds_return_map >/dev/null 2>&1 || { rm -rf \"$__ds_cv_tmpdir\"; __ds_error 'invalid internal map function return payload'; }; declare -p __ds_return_value_type >/dev/null 2>&1 || declare -gA __ds_return_value_type=(); fi\n"
        ...
        "    command_result) printf -v \"${__ds_cv_target}_stdout\" '%s' \"${__ds_return_stdout-}\"; printf -v \"${__ds_cv_target}_stderr\" '%s' \"${__ds_return_stderr-}\"; printf -v \"${__ds_cv_target}_code\" '%s' \"${__ds_return_code-0}\"; printf -v \"${__ds_cv_target}_ok\" '%s' \"${__ds_return_ok-false}\"; printf -v \"${__ds_cv_target}_failed\" '%s' \"${__ds_return_failed-true}\"; printf -v \"__ds_type_${__ds_cv_meta}\" '%s' command_result ;;\n"
