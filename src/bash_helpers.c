...
const char *ds_bash_function_value_helpers_source(void) {
    return
        ...
        "  local __ds_cv_target=\"$1\" __ds_cv_key\n"
        "  case \"$__ds_return_type\" in\n"
        "    array) eval \"$__ds_cv_target=()\"; for __ds_cv_key in \"${!__ds_return_array[@]}\"; do eval \"$__ds_cv_target+=(\\\"\\${__ds_return_array[\\$__ds_cv_key]}\\\")\"; done; printf -v \"__ds_type_${__ds_cv_target}\" '%s' array; printf -v \"__ds_elem_type_${__ds_cv_target}\" '%s' \"${__ds_return_elem_type:-unknown}\" ;;\n"
        "    map) eval \"$__ds_cv_target=()\"; for __ds_cv_key in \"${!__ds_return_map[@]}\"; do eval \"$__ds_cv_target[\\$__ds_cv_key]=\\\"\\${__ds_return_map[\\$__ds_cv_key]}\\\"\"; done; printf -v \"__ds_type_${__ds_cv_target}\" '%s' map ;;\n"
        "    command_result) printf -v \"${__ds_cv_target}_stdout\" '%s' \"${__ds_return_stdout-}\"; printf -v \"${__ds_cv_target}_stderr\" '%s' \"${__ds_return_stderr-}\"; printf -v \"${__ds_cv_target}_code\" '%s' \"${__ds_return_code-0}\"; printf -v \"${__ds_cv_target}_ok\" '%s' \"${__ds_return_ok-false}\"; printf -v \"${__ds_cv_target}_failed\" '%s' \"${__ds_return_failed-true}\"; printf -v \"__ds_type_${__ds_cv_target}\" '%s' command_result ;;\n"
