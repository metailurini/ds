...
typedef struct {
    ...
    bool uses_run;
    bool uses_stdlib;
    bool uses_stdlib_capture;
    bool uses_glob_helpers;
    bool uses_recursive_glob_helpers;
    bool uses_regex_base_helpers;
    bool uses_regex_match_helpers;
    bool uses_regex_replace_helpers;
    bool uses_collection_index;
    bool uses_array_helpers;
    bool uses_map_helpers;
    bool uses_map_iteration;
    bool uses_map_assignment;
    bool uses_map_literal;
    bool uses_case;
    bool uses_membership;
    bool uses_function_param_types;
    bool uses_int_helpers;
    bool uses_function_value_helpers;
    bool uses_handlers;
    bool uses_signal_handlers;
    bool uses_control_commands;
    unsigned string_helper_mask;
} BashDeps;
