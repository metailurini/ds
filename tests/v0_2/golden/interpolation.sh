...
__ds_trace_cmd 'tests/v0_2/fixtures/interpolation.ds':3:1 echo "${__ds_first} ${__ds_last}!"
( echo "${__ds_first} ${__ds_last}!" ) || __ds_fail 'tests/v0_2/fixtures/interpolation.ds':3:1 "$?" 1
