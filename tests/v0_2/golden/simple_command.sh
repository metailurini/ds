...
# ds: tests/v0_2/fixtures/simple_command.ds:1
__ds_trace_cmd 'tests/v0_2/fixtures/simple_command.ds':1:1 echo "hello world"
( echo "hello world" ) || __ds_fail 'tests/v0_2/fixtures/simple_command.ds':1:1 "$?" 1
