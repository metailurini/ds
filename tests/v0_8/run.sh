...
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_result_field_lookup" "command-result field lookup is centralized"
assert_contains "$ROOT/src/ds_command_facts.c" '"status", "code"' "command-result status storage alias is centralized"
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_result_field_count" "command-result field catalog exposes iteration"
...
assert_contains "$ROOT/src/bash_stmt.c" "bash_emit_array_return_payload" "Bash return emission delegates structured array payloads"
assert_contains "$ROOT/src/bash_stmt.c" "bash_emit_map_return_payload" "Bash return emission delegates structured map payloads"
...
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_word_analyze" "command-word shape classification is centralized"
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_word_contains_direct_call_interpolation" "direct call interpolation detection is centralized"
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_is_pipeline" "pipeline shape classification is centralized"
assert_contains "$ROOT/src/ds_command_facts.c" "ds_command_pipeline_status" "pipeline pipefail status policy is centralized"
