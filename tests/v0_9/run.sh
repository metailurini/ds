...
assert_contains "$TMP/bytecode_defaults.out" 'param 1 b: string = string "x"' "bytecode prints string default metadata"
assert_contains "$TMP/bytecode_defaults.out" 'param 2 c: int = int 0' "bytecode prints int default metadata"
assert_contains "$TMP/bytecode_defaults.out" 'param 3 d: bool = bool false' "bytecode prints bool default metadata"
